...
namespace Shears
{
    public class Plugin : IDalamudPlugin
    {
        ...
        private void ChangeRace(IntPtr customizeDataPtr, Race targetRace, bool ForceChange = false)
        {
            ...
            if (PluginConfig.OnlyChangeHrothgars && lastWasSelf == false && ForceChange == false)
            {
        ...
        {
            if (PluginConfig.OnlyChangeHrothgars == onlyChangeHrothgars)
            {
                return;
            }

            PluginLog.Log($"Only change Hrothgar players toggled to {onlyChangeHrothgars}, refreshing players");
            PluginConfig.OnlyChangeHrothgars = onlyChangeHrothgars;
